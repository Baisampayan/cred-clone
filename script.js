const section4 = document.querySelector('.section-sixth')

const section4Left1 = document.querySelector('.left-content-1')
const section4Left2 = document.querySelector('.left-content-2')
const section4Left3 = document.querySelector('.left-content-3')
const section4Left4 = document.querySelector('.left-content-4')
